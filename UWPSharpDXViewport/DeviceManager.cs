...
namespace UWPSharpDXViewport
{
    ...
    {
        public SwapChainViewport viewport;
        ...
        /// <summary>
        /// This event is fired when the DeviceMamanger is initialized by the <see cref="OnInitialize"/> method.
        /// </summary>
        public event Action<DeviceManager> Initialize;

        /// <summary>
        /// Initialize this instance.
        /// </summary>
        /// <param name="window">Window to receive the rendering</param>
        public virtual void OnInitialize(float dpi, SwapChainViewport viewport)
        {
