...
namespace MonteHalo
{
    namespace Graphics
    {
        ...
        public class TestPointPlot : Element3D
        {            
            ...
            public override void Initialize(DeviceManager _deviceManager)
            {
                ...
                this.context = _deviceManager.ContextDirect3D;
                this.device = _deviceManager.DeviceDirect3D;
                this.pointCount = 0;
            ...
            public void UpdateVertexBuffer(ScatterVertex data)
            {
                ...
                //    out stream
                //    );
                //stream.Write<ScatterVertex>(data);
                this.context.UnmapSubresource(scatterPointVertexBuffer, 0);
                this.pointCount++;
            }
            public void UpdateVertexBuffer(ref ScatterVertex[] _array)
            {
                DataBox dataBox =
                this.context.MapSubresource(
                    scatterPointVertexBuffer,
                ...
                {
                    pointer = Utilities.WriteAndPosition(pointer, ref _array[i]);
                    this.pointCount++;
                }                
                this.context.UnmapSubresource(scatterPointVertexBuffer, 0);
